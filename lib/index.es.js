...
function formatRelative(config, formatters, value) {
  ...
  var locale = config.locale,
      ...
      formats = _config$formats === undefined ? {} : _config$formats;
  var now = options.now,
      _options$format = options.format,
      format = _options$format === undefined ? '' : _options$format,
      userOptions = objectWithoutProperties(options, ['now', 'format']);


  var dateObject = createDate(value);
  var nowObject = flow(defaultTo(Date.now()), createDate)(now);
  var defaultOptions = getOr({}, 'relative.' + format)(formats);

  var formatter = formatters.getRelativeFormat(locale, _extends({}, defaultOptions, userOptions));
...
function formatNumber(config, formatters, value) {
  ...
  var locale = config.locale,
      ...
      formats = _config$formats2 === undefined ? {} : _config$formats2;
  var _options$format2 = options.format,
      format = _options$format2 === undefined ? '' : _options$format2,
      userOptions = objectWithoutProperties(options, ['format']);


  var defaultOptions = getOr({}, 'number.' + format)(formats);
  var formatter = formatters.getNumberFormat(locale, _extends({}, defaultOptions, userOptions));
...
function formatDate(config, formatters, value) {
  ...
  var locale = config.locale,
      ...
      formats = _config$formats3 === undefined ? {} : _config$formats3;
  var _options$format3 = options.format,
      format = _options$format3 === undefined ? '' : _options$format3,
      userOptions = objectWithoutProperties(options, ['format']);


  var dateObject = createDate(value);
  var defaultOptions = getOr({}, 'date.' + format)(formats);
  var formatter = formatters.getDateTimeFormat(locale, _extends({
    year: 'numeric',
    month: 'numeric',
    day: 'numeric'
...
function formatTime(config, formatters, value) {
  ...
  var locale = config.locale,
      ...
      formats = _config$formats4 === undefined ? {} : _config$formats4;
  var _options$format4 = options.format,
      format = _options$format4 === undefined ? '' : _options$format4,
      userOptions = objectWithoutProperties(options, ['format']);


  var dateObject = createDate(value);
  var defaultOptions = getOr({}, 'time.' + format)(formats);
  var formatter = formatters.getDateTimeFormat(locale, _extends({
    hour: 'numeric',
    minute: 'numeric'
  }, defaultOptions, userOptions));
...
var createFormatters = function createFormatters(intlConfig) {
  ...
  return _extends({}, intlConfig, boundFormatFns, {
...
var FormattedMessage = function FormattedMessage(_ref) {
  var _ref$component = _ref.component,
      Component = _ref$component === undefined ? getDefaultComponent() : _ref$component,
      id = _ref.id,
  ...
  return React.createElement(
    Component,
    null,
    intl.formatMessage({ id: id, description: description, defaultMessage: defaultMessage }, values)
  );
};
...
var FormattedRelative = function FormattedRelative(_ref) {
  ...
  return React.createElement(
    Component,
    null,
    intl.formatRelative(value, omitBy(isUndefined$1)({ now: initialNow, format: format, style: style, units: units }))
  );
};
...
var FormattedNumber = function FormattedNumber(_ref) {
  ...
  return React.createElement(
    Component,
    null,
    intl.formatNumber(value, omitBy(isUndefined$1)({
      format: format,
...
var acceptEmptyString = (function (object) {
  return Object.keys(object).reduce(function (result, key) {
    return _extends({}, result, defineProperty$2({}, key, object[key] === '' ? undefined : object[key]));
  }, {});
});
...
var FormattedDate = function FormattedDate(_ref) {
  ...
  return React.createElement(
    Component,
    null,
    intl.formatDate(value, flow(omitBy(isUndefined$1), acceptEmptyString)({
      format: format,
      localeMatcher: localeMatcher,
...
export { injectIntl, createFormatters, connectAndInjectIntl, intlReducer, changeLocaleAction, addLocaleData, setDefaultComponent, getDefaultComponent, FormattedMessage$1 as FormattedMessage, FormattedRelative$1 as FormattedRelative, FormattedNumber$1 as FormattedNumber, FormattedDate$1 as FormattedDate, Intl$1 as Intl };
