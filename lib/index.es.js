...
var defaultTo = (function (defaultValue) {
  return function (value) {
...
function formatRelative(config, formatters, value) {
  ...
  var formatter = formatters.getRelativeFormat(locale);
  var formattedRelative = formatter.format(date);
...
var withProps = (function (withPropsFn) {
  return function (Component$$1) {
    return function (props) {
      return React.createElement(Component$$1, _extends({}, props, withPropsFn(props)));
    };
  };
});

var intlFormatMethodNames = ['formatMessage', 'formatRelative'];
...
var _symbolObservable2 = _interopRequireDefault(symbolObservable);
...
var createStore_2 = createStore_1.ActionTypes;
...
var combineReducers_1 = createCommonjsModule(function (module, exports) {
...
function getUnexpectedStateShapeWarningMessage(inputState, reducers, action) {
  ...
  var argumentName = action && action.type === createStore_1.ActionTypes.INIT ? 'initialState argument passed to createStore' : 'previous state received by the reducer';
...
function assertReducerSanity(reducers) {
  Object.keys(reducers).forEach(function (key) {
    ...
    var initialState = reducer(undefined, { type: createStore_1.ActionTypes.INIT });
    ...
    if (typeof reducer(undefined, { type: type }) === 'undefined') {
      throw new Error('Reducer "' + key + '" returned undefined when probed with a random type. ' + ('Don\'t try to handle ' + createStore_1.ActionTypes.INIT + ' or other actions in "redux/*" ') + 'namespace. They are considered private. Instead, you must return the ' + 'current state for any unknown actions, unless it is undefined, ' + 'in which case you must return the initial state, regardless of the ' + 'action type. The initial state may not be undefined.');
    }
  });
}
...
unwrapExports(combineReducers_1);
...
unwrapExports(bindActionCreators_1);
...
var applyMiddleware_1 = createCommonjsModule(function (module, exports) {
...
unwrapExports(applyMiddleware_1);
...
var _combineReducers2 = _interopRequireDefault(combineReducers_1);



var _bindActionCreators2 = _interopRequireDefault(bindActionCreators_1);



var _applyMiddleware2 = _interopRequireDefault(applyMiddleware_1);
...
var lib_2 = lib.applyMiddleware;
var lib_3 = lib.bindActionCreators;
var lib_4 = lib.combineReducers;
var lib_5 = lib.createStore;
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && typeof mapDispatchToProps === 'object' ? wrapMapToPropsConstant(function (dispatch) {
    return lib_3(mapDispatchToProps, dispatch);
  }) : undefined;
}
