...
function formatRelative(config, formatters, value) {
  ...
  var now = options.now,
      userOptions = objectWithoutProperties(options, ['now']);


  var dateObject = createDate(value);
  var nowObject = flow(defaultTo(Date.now()), createDate)(now);
  var defaultOptions = getOr({}, 'relative')(formats);
...
function formatNumber(config, formatters, value) {
  ...
  var defaultOptions = getOr({}, 'number')(formats);
  var formatter = formatters.getNumberFormat(locale, _extends({}, defaultOptions, options));
...
function formatDate(config, formatters, value) {
  ...
  var dateObject = createDate(value);
  var defaultOptions = getOr({}, 'date')(formats);
...
function formatTime(config, formatters, value) {
  ...
  var dateObject = createDate(value);
  var defaultOptions = getOr({}, 'time')(formats);
  var formatter = formatters.getDateTimeFormat(locale, _extends({
    hour: 'numeric',
    minute: 'numeric'
  }, defaultOptions, options));
